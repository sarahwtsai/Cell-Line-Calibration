...
M5_bounds = [[0.001, 0.065], [0.0, 0.03], [15000, 90000.0], [0.0001, 0.0002], [0.0, 1000.0], [700, 3000]]
...
M9_bounds = [[0.001, 0.065], [0.0, 0.03], [15000, 90000.0], [0.0001, 0.0002], [0.0, 1000.0], [700, 3000]]
M10_bounds = [[0.001, 0.065], [0.0, 0.03], [15000, 90000.0], [0.0001, 0.0002], [0.0, 1000.0], [700, 3000]]
...
for test_num in range(30):
    ...
    true_r = np.random.uniform(0.0001, 0.0002)
    true_g = np.random.uniform(0.001, 0.008)
    true_ic = np.random.uniform(700, 3000)


    true_param = [true_p, true_d, true_K, true_r, true_ic]
    ...
    for i in range (len(perturb_perc)):
        ...
        true_data = gen.gen_true_data(gen.test_M9, [true_ic], times, [true_p, true_d, true_K, true_r])
